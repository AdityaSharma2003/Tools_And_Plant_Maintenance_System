...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(3, 219, 241));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(txtID.getText().isEmpty()){
        ...
        else if(txtUsr.getText().isEmpty()){
            ...
            try {
                ...
                pst = con.prepareStatement("select * from employee where emp_ID=? and emp_name=? and emp_password=?");
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(this,"The entered details do not exist in the database");
                    txtID.setText("");
                    txtUsr.setText("");
                    txtPass.setText("");
                }
